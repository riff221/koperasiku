...
<html lang="en">
  <head>
    ...
    <title>Details | KoperasiKU</title>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 d-flex justify-content-between">
                ...
                <div>
                  <p>
                    Tersedia : <strong><?= $product["stock"] / 1; ?> Unit</strong>
                  </p>
                </div>
              </div>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-12">
            <p class="pt-4 pb-2">
              2023 Create by KoperasiKU. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
    ...
    <script>
      var gallery = new Vue({
        ...
        data: {
          activePhoto: 1,
          photos: [
            <?php foreach ($products_galleries as $gallery) : 
            ?>{
