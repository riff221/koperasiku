      ...
      <section class="store-landing">
        <div class="container">
          <div class="row align-items-center justify-content-between">
            <div class="col-md-5">
              <img src="assets/images/berlin.png" class="w-100" alt="" />
            </div>
            <div class="col-md-6">
              <h1 style="font-weight: bold; margin-bottom: 15px;">Koperasi Digital</h1>
              <p class="store-subtitle-landing" style="line-height: 28px; color: #000;">
                Koperasi Sekolah Digital adalah toko penyedia alat tulis dan beberapa atribut sekolah,
                toko ini mempunyai harga yang murah dan memiliki pelayanan yang baik dan dapat dipercaya
              </p>
                    ...
                    <div class="col-md-8">
                      ...
                      >
                        ...
                        <div class="subtitle-text">
                          Mengantarkan barang dengan cepat dan hanya dapat mengantarkan didalam area sekolah 
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      ...
                      >
                        ...
                        <div class="subtitle-text">
                          Harga barang lebih murah dan terpercaya
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      <div
                        class="adventege-description text-center text-lg-left"
                      >
                        <div class="title-text"><b>Open And Close</b></div>
                        <div class="subtitle-text">
                          Buka hanya di dalam Jam pelajaran sekolah sampai selesainya dan tutup jika disekolah tidak ada kegiatan
                        </div>
                      </div>
                    </div>
                  </div>
