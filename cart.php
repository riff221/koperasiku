  ...
  <div class="page-content page-cart">
                ...
                <?php foreach ($carts as $cart) : ?>
                  ...
                  <tr>
                    ...
                    <td style="width: 20%;">
                      ...
                      <div class="product-subtitle"><?= $cart["unit"] / 1; ?> Unit</div>
                    </td>
                    <td style="width: 10%;">
          ...
          <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
            ...
            <?php if ($berat >= 1) : ?>
              <div class="col-md-12 text-center my-4" id="alert-berat">
                <h5>Banyak barang anda lebih dari <strong>10 Unit</strong></h5>
    ...
    <footer>
      <div class=" container">
        <div class="row">
          <div class="col-12">
            <p class="pt-4 pb-2">&copy; <?= date('Y'); ?> 2023 Create by KoperasiKU. All Rights Reserved.</p>
          </div>
        </div>
      </div>
    </footer>
